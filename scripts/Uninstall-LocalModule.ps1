...
try {
    # Determine Documents path (handles OneDrive redirect)
    ...
    if (-not (Test-Path $modulePath)) {
        ...
        # Also check other PSModulePath entries in case it was installed elsewhere
    ...
    # Attempt to remove module from current session
